...
CREDITS = f"""dynamight has been written by Steve Doyle since 2023.  This product contains the following third party modules:
...
class AboutWindow(PyDialog):
    ...
    def on_update(self):
        ...
        if not is_newer:
            ...
            QMessageBox.about(self, 'About dynamight GUI', 'dynamight GUI is already up to date')
...
def get_packages() -> dict[str, str]:
    ...
    # 'pandas', 'h5py', 'tables', 'imageio', 'PIL', 'pygments'
...
def get_version() -> dict[str, str]:
    ...
    version_data = {
        'Product': 'dynamight GUI',
        'Version': dynamight.__version__,
        'Release Type': 'Final Release' if 'dev' not in dynamight.__version__ else 'Developement',
